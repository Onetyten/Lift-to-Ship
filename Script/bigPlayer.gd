...
@export var small_state:NodeState
...
@export var jump_buffer : float = 15
...
func set_direction() -> void:
	...
	face_direction = character.direction# remember direction
...
func switch_up():
	if Input.is_action_just_pressed("Switch"):
		finite_state_machine.transition_to("Small")
...
func enter():
	face_direction = small_state.face_direction
	Global.player_scale = 2
	state_animation.play("big")
